...
Manage Microsoft (Bing) Ads campaigns with AI agents via MCP.

 `microsoft-ads` `bing-ads` `search-advertising` `mcp` `ai-agents`

---

## What is this?

Open this repo in **Amp**, **Cursor**, or **VS Code** and your AI agent can immediately manage Microsoft Ads — no SDK to install, no dependencies. The [Synter MCP server](https://github.com/Synter-Media-AI/mcp-server) is already configured.
...
> List active Microsoft Ads campaigns

> Create a search campaign targeting 'accounting software'

> Check conversion tracking status

> Update daily budget for my brand campaign

> Pull performance report for the last 7 days
